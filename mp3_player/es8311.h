 ...
 *     - Else fail
 */
esp_err_t es8311_init(i2c_master_dev_handle_t dev, const es8311_clock_config_t *const clk_cfg, const es8311_resolution_t res_in,
 ...
 *     - Else fail
 */
esp_err_t es8311_voice_mute(i2c_master_dev_handle_t dev, bool enable);
